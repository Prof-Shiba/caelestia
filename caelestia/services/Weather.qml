...
Singleton {
    ...
    readonly property string icon: cc ? Icons.getWeatherIcon(cc.weatherCode) : "☁️"
    readonly property string description: cc?.weatherDesc[0].value ?? qsTr("Failed to fetch")
