...
rofi_theme="$HOME/.local/share/rofi/launchers/type-1/style-3.rasi"
rofi_theme_1="$HOME/.local/share/rofi/launchers/type-1/style-3.rasi"
...
declare -A online_music=(
  ...
  ["YT - Lofi-Girl Youtube"]="https://www.youtube.com/live/jfKfPfyJRdk"
  ["YT - Lofi-Girl Christmas 🎄"]="https://www.youtube.com/watch?v=C4qJeIjNd2U"
)
...
stop_music() {
  ...
  if [ -n "$mpv_pids" ]; then
    ...
    notify-send -u normal "Music stopped" || true
  fi
}
